...
# csv_list = []
runner = run_postgres.pg_stats('2015-01-01', '2015-12-31', pg_csv)
...
runner = run_postgres.pg_stats('2015-01-01','2015-12-31', my_csv, sql=sql)

#
hive_csv = "/home/jan/Documents/test_hive%s.csv"
# runner = run_hive.hive_stats('2015-10-01', '2015-11-30', hive_csv)
runner = run_hive.hive_stats('2015-01-01', '2015-12-31', hive_csv)
